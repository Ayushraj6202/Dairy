    ...
    return (
        <div className="container mx-auto px-4">
            ...
            <div className="text-center text-2xl md:text-3xl lg:text-4xl mt-2 bg-gradient-to-r from-blue-400 to-blue-600 text-white p-4 rounded-lg shadow-md">
                हम आपका स्वागत करते हैं, ग्राहक भगवान है
            </div>

            {/* Slideshow */}
            <div className="my-6 shadow-lg border-4 border-blue-200 rounded-lg">
                <SlideShow />
            </div>
            ...
            {/* Product Description */}
            <div className="text-base md:text-lg lg:text-xl bg-blue-300 p-4 rounded-lg text-center text-gray-800 shadow-sm">
            ...
            <div className="mt-6 text-sm md:text-base lg:text-lg text-center text-gray-700 my-1">
                ...
                <p className="mt-4 bg-blue-300 p-4 rounded-lg shadow-md">आपके आराम के लिए हमारी ऑनलाइन सेवा उपलब्ध है, और ऑर्डर किए गए उत्पाद आपके दरवाजे तक पहुंचाए जाएंगे।</p>
            </div>
        </div>
    );
}
